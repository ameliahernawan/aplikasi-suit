        ...
        <View style={{ flexDirection: 'row', flex: 1, marginTop: 10 }}>
          <ImageBackground source={splash} style={styles.splash}>
            <View style={styles.winstreakText}>
              <Text style={[styles.text, { fontSize: 75, textAlign: 'center' }]}>{stats?.winstreak}</Text>
            </View>
          </ImageBackground>
      ...
      <View style={{ flexDirection: 'row' }}>
        <View style={{ flex: 1, alignItems: 'center' }}>
          <View style={{ padding: 1 }}>
            <Text style={[styles.text, { fontSize: 18, textAlign: 'center', color: '#02CCB0' }]}>Win</Text>
            <ImageBackground source={statsContainer} style={styles.statsContainer}>
        ...
        <View style={{ flex: 1, alignItems: 'center' }}>
          <View style={{ padding: 1 }}>
            <Text style={[styles.text, { fontSize: 18, textAlign: 'center' }]}>Tie</Text>
            <ImageBackground source={statsContainer} style={styles.statsContainer}>
              <View style={styles.textContainerStats}>
        ...
        <View style={{ flex: 1, alignItems: 'center' }}>
          <View style={{ padding: 1 }}>
            <Text style={[styles.text, { fontSize: 18, color: 'red', textAlign: 'center' }]}>Losses</Text>
            <ImageBackground source={statsContainer} style={styles.statsContainer}>
              <View style={styles.textContainerStats}>
